<main class="no-padding overflow-hidden h-100vh p-8 flex flex-col gap-8 items-center">
  <?= view('components/app/logo') ?>
  <div class="flex flex-col gap-2">
    <h3 class="text-text font-main font-semibold text-2xl">
  ...
  <form class="w-full flex flex-col gap-4 items-center" id="login-form" action="<?= base_url() . "api/auth/login" ?>"
    method="POST">
    ...
    <input type="hidden" name="fallback" value="<?= isset ($_GET["fallback"]) ? $_GET["fallback"] : null ?>"
      data-valid="true" />
  </form>
  <div class="fixed inset-x-8 bottom-8 flex gap-4">
